...
public class EmployeesEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Employees Edit");
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
				        ...
				        datePickerDialog = new DatePickerDialog(EmployeesEditActivity.this,
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IsValid()) {
					...
					model.setEmployeeID(new Integer(tvEmployeeID.getText().toString()));
    ...
    private void GetEmployees(Integer EmployeeID) {
        ...
        if (data != null) {
			...
			etLastName.setText(String.valueOf(data.getLastName()));
			etFirstName.setText(String.valueOf(data.getFirstName()));
			etTitle.setText(String.valueOf(data.getTitle()));
			etTitleOfCourtesy.setText(String.valueOf(data.getTitleOfCourtesy()));
			etBirthDate.setText(Converter.formatDate(data.getBirthDate()));
			etHireDate.setText(Converter.formatDate(data.getHireDate()));
			...
			etHomePhone.setText(String.valueOf(data.getHomePhone()));
			etExtension.setText(String.valueOf(data.getExtension()));
			etPhoto.setText(String.valueOf(data.getPhoto()));
			etNotes.setText(String.valueOf(data.getNotes()));
			etReportsTo.setText(String.valueOf(data.getReportsTo()));
			etPhotoPath.setText(String.valueOf(data.getPhotoPath()));
        }
        else {
    ...
    void EditEmployees(EmployeesDto item) {
        if (item != null) {
            _EmployeesRepository.Put(item);
