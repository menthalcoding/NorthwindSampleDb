...
public class OrderDetailsDetailActivity extends AppCompatActivity {
	TextView tvOrderId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdetails_detail);
        getSupportActionBar().setTitle("OrderDetails Detail");
