...
public class CustomersDemographicsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customersdemographics_detail);
        getSupportActionBar().setTitle("CustomersDemographics Detail");
