...
public class EmployeesDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employees_delete);
        getSupportActionBar().setTitle("Employees Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DeleteEmployees(new Integer(tvEmployeeID.getText().toString()));
            }
        });
    ...
    private void DeleteEmployees(Integer EmployeeID) {
        ...
        _EmployeesRepository.Delete(criteria);
