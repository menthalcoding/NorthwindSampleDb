...
public class SuppliersEditActivity extends AppCompatActivity {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IsValid()) {
					...
					model.setSupplierID(new Integer(tvSupplierID.getText().toString()));
    ...
    private void GetSuppliers(Integer SupplierID) {
        ...
        if (data != null) {
			...
			etHomePage.setText(String.valueOf(data.getHomePage()));
        }
        else {
    ...
    void EditSuppliers(SuppliersDto item) {
        if (item != null) {
            _SuppliersRepository.Put(item);
