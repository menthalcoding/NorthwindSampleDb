...
public class ProductsEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Products Edit");
    ...
    private void GetProducts(Integer ProductId) {
        ...
        if (data != null) {
			...
			etProductName.setText(String.valueOf(data.getProductName()));
			String selValSupplierID = "";
            for (SuppliersDto item : _SuppliersList) {
				if (item.getSupplierID().equals(data.getSupplierID())) {
					selValSupplierID = String.valueOf(item.getCompanyName());
			        spnSuppliersSupplierID.setSelection(SuppliersSupplierIDAdapter.getPosition(selValSupplierID));
                    break;
                }
			}
			String selValCategoryID = "";
            for (CategoriesDto item : _CategoriesList) {
				if (item.getCategoryID().equals(data.getCategoryID())) {
					selValCategoryID = String.valueOf(item.getCategoryName());
			        spnCategoriesCategoryID.setSelection(CategoriesCategoryIDAdapter.getPosition(selValCategoryID));
                    break;
                }
			}
			etQuantityPerUnit.setText(String.valueOf(data.getQuantityPerUnit()));
			etUnitPrice.setText(String.valueOf(data.getUnitPrice()));
			etUnitsInStock.setText(String.valueOf(data.getUnitsInStock()));
			etUnitsOnOrder.setText(String.valueOf(data.getUnitsOnOrder()));
			etReorderLevel.setText(String.valueOf(data.getReorderLevel()));
			etDiscontinued.setText(String.valueOf(data.getDiscontinued()));
        }
        else {
    ...
    void EditProducts(ProductsDto item) {
        if (item != null) {
            _ProductsRepository.Put(item);
