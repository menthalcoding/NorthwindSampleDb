...
public class RegionDeleteActivity extends AppCompatActivity {
	TextView tvRegionID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_region_delete);
        getSupportActionBar().setTitle("Region Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DeleteRegion(new Integer(tvRegionID.getText().toString()));
            }
        });
    ...
    private void DeleteRegion(Integer RegionID) {
        RegionCriteria criteria = new RegionCriteria();
		criteria.RegionID = RegionID;
        _RegionRepository.Delete(criteria);
