...
public class ShippersDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shippers_delete);
        getSupportActionBar().setTitle("Shippers Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DeleteShippers(new Integer(tvShipperId.getText().toString()));
            }
        });
    ...
    private void DeleteShippers(Integer ShipperId) {
        ShippersCriteria criteria = new ShippersCriteria();
		criteria.ShipperId = ShipperId;
        _ShippersRepository.Delete(criteria);
