...
public class MainActivity extends Activity {
    ...
    ListView listView;
    private String[] items = { "Categories","Customers","CustomersCustomersDemo","CustomersDemographics","Employees","EmployeesTerritories","Order","OrderDetails","Products","Region","Shippers","Suppliers","Territories" };
