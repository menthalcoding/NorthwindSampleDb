...
public class SuppliersDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suppliers_delete);
        getSupportActionBar().setTitle("Suppliers Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DeleteSuppliers(new Integer(tvSupplierID.getText().toString()));
            }
        });
    ...
    private void DeleteSuppliers(Integer SupplierID) {
        SuppliersCriteria criteria = new SuppliersCriteria();
		criteria.SupplierID = SupplierID;
        _SuppliersRepository.Delete(criteria);
